...
The application MUST display a primary navigation shell titled "Aqua Flow" providing access to Home, Field, Control, Manual Control, and Settings screens with "Aqua Flow Dashboard" branding headers, guarded by user authentication state.
